...
export const MACHIAS_ORG_SEED = [
  ...
  { _key: 'sa_role', name: 'Staff Accountant', node_type: 'staff_role', branch: 'municipal', parent_id: 'finance_dir', sort_order: 2,
    ...
    restructuring_notes: 'Phase 1 new hire. Resolves separation-of-duties deficiency. Funded by General Fund. Reports to Finance Director.' },
  { _key: 'bs_role', name: 'Billing Specialist', node_type: 'staff_role', branch: 'municipal', parent_id: 'finance_dir', sort_order: 3,
    description: 'In-house EMS billing, AR management, external municipal billing services.',
    restructuring_status: 'proposed_new',
    restructuring_notes: 'Phase 1 new hire (Month 7). Replaces Comstar contract. Funded by Ambulance Enterprise Fund. Reports to Finance Director.' },
  { _key: 'ga_role', name: 'GA Coordinator', node_type: 'staff_role', branch: 'municipal', parent_id: 'finance_dir', sort_order: 4,
    description: 'General Assistance program administration, grant tracking, federal/state compliance.',
    restructuring_status: 'proposed_new',
    restructuring_notes: 'Phase 1 stipend position (Month 9). Reports to Finance Director or Town Manager — configurable in Model Settings.' },
  { _key: 'rc_role', name: 'Revenue Coordinator', node_type: 'staff_role', branch: 'municipal', parent_id: 'finance_dir', sort_order: 5,
    description: 'Manages regional services contracts and relationships with member municipalities.',
    restructuring_status: 'proposed_new',
    restructuring_notes: 'Trigger-based hire Year 3 — only when regional revenue covers fully loaded cost. Reports to Finance Director.' },
  { _key: 'controller_role', name: 'Controller', node_type: 'staff_role', branch: 'municipal', parent_id: 'finance_dir', sort_order: 6,
    description: 'Senior financial oversight, internal controls, financial reporting. Year 5 hire (½ year).',
    restructuring_status: 'proposed_new',
    restructuring_notes: 'Year 5 senior hire — toggle between Controller and 2nd Staff Accountant in Model Settings. Reports to Finance Director.' },
